import {HashtagWithCounts, PostContentType, PostType, ProfileDataType} from "../type/type";
import {hashtagsData} from "../data/data";

export const determinePostType = (post: PostType): PostContentType =>  {
    if (post.attachments && post.attachments.length > 0) {
        ...
        if (firstAttachment.type === 'video') {
            ...
            return 'image';
        } else if (firstAttachment.type === 'gif') {
            return 'gif';
        }
    }
    return 'text';
